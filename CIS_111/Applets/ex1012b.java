/* Exercise 10-12a
 * This applet will eat a slice of pizza
 * */
...
public class ex1012b extends JApplet implements ActionListener
{
  ...
  public void paint(Graphics g)
  {
     ...
     switch (count)
     {
       ...
       case 1:
       {
         g.fillArc(50, 50, 100, 100, 90, 270); 
         g.setColor(Color.red);
         g.fillOval(75, 75, 10, 10);
         g.fillOval(75, 115, 10, 10);
         g.fillOval(115, 115, 10, 10);
        ...
        case 2:
       {
         g.fillArc(50, 50, 100, 100, 180, 180); 
         g.setColor(Color.red);
         g.fillOval(75, 115, 10, 10);
         g.fillOval(115, 115, 10, 10);
         break;
